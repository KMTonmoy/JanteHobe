...
const EditBanner = () => {
    ...
    useEffect(() => {
        const fetchBannerData = async () => {
            try {
                const response = await fetch('https://jantehobeback.vercel.app/banners');
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await fetch(`https://jantehobeback.vercel.app/banners/${id}`, { method: 'DELETE' });
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await fetch(`https://jantehobeback.vercel.app/banners/${_id}`, {
                method: 'PATCH',
                headers: {
