    ...
    return (
        <div className="w-full flex flex-col">
            <div className="w-full py-5 px-10">
                <div
                    className="w-full border-2 rounded-xl border-[#F43F5E] h-[500px] cursor-pointer"
                        ...
                        <div>
                            {preview ? (
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="text-6xl font-bold text-[#F43F5E] mt-3">+</p>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="bg-white w-1/3 rounded-lg shadow-lg p-8">
                            ...
                            <div className="flex justify-end space-x-4">
                                ...
                                <button
                                    ...
                                    className="bg-[#F43F5E] hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded-lg"
                                >
                                    Submit
                                </button>
                            </div>
